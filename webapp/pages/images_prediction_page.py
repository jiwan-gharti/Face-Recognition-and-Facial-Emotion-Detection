        ...
        if btn:
            ...
            for (x,y,w,h) in faces:
                ...
                if area > 3000:
                    ...
                    #     cv2.putText(image,f'{gender_classification}',(x, y-20),cv2.FONT_HERSHEY_COMPLEX,label_size,(255,0,0),2)
                    ...
                    #     cv2.putText(image,f"{predicted_age}",(x+w, y+150),cv2.FONT_HERSHEY_COMPLEX,label_size,(255,0,0),2)
            ...
            # with placeholder.container():s
                ...
                #         text=y,
                #         color=x,
                #         title="Age Range Prediction",
                #         height=400,
                #         labels = {
                #             'x':'Age Range',
                #             'y': 'Age Prediction Percentage'
                #         }
                #     )
